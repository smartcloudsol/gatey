...
<div gatey-authenticator id="<?php echo esc_html($bid) ?>"
	...
	data-direction="<?php echo esc_html(array_key_exists('direction', $attributes) ? $attributes['direction'] : 'dependent') ?>"
